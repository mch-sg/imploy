...
import { Building, MapPin, Clock, Briefcase, Filter } from "lucide-react"
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (activeFilter === "All Jobs") {
      ...
      filtered = jobListings.filter((job) => job.type.includes(activeFilter))
    }
      ...
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <main className="flex-1 container mx-auto py-6 px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[calc(100vh-5rem)]">
            {/* Left column - Fixed sidebar with scrollable job listings */}
            <div className="md:col-span-1 flex flex-col h-full">
              {/* Filter dropdown - fixed at top */}
              <div className="mb-4 bg-background z-10 py-2">
              ...
              <div id="job-listings" className="overflow-y-auto pr-2 flex-1">
            ...
            <div
              className="md:col-span-2 border rounded-lg h-full overflow-hidden flex flex-col">
